...
*Currently the build for MinimalComps pulls from "my fork":https://github.com/connatser/minimalcomps of Keith Peter's MinimalComps repository, which is currently in pull request status.
